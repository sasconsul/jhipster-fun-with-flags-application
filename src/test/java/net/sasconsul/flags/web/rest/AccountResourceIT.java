...
import net.sasconsul.flags.config.Constants;
import net.sasconsul.flags.domain.Authority;
import net.sasconsul.flags.domain.User;
import net.sasconsul.flags.repository.AuthorityRepository;
import net.sasconsul.flags.repository.UserRepository;
import net.sasconsul.flags.security.AuthoritiesConstants;
import net.sasconsul.flags.service.MailService;
import net.sasconsul.flags.service.UserService;
import net.sasconsul.flags.service.dto.PasswordChangeDTO;
import net.sasconsul.flags.service.dto.UserDTO;
import net.sasconsul.flags.web.rest.errors.ExceptionTranslator;
import net.sasconsul.flags.web.rest.vm.KeyAndPasswordVM;
import net.sasconsul.flags.web.rest.vm.ManagedUserVM;
