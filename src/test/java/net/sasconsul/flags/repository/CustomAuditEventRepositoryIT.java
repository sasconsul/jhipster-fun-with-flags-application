...
import net.sasconsul.flags.config.audit.AuditEventConverter;
import net.sasconsul.flags.domain.PersistentAuditEvent;
...
import static net.sasconsul.flags.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
