  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterFunWithFlagsApp.country.delete.question">
          <Translate contentKey="jhipsterFunWithFlagsApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
