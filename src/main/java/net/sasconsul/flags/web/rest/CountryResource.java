...
import net.sasconsul.flags.domain.Country;
import net.sasconsul.flags.repository.CountryRepository;
...
/**
 * REST controller for managing {@link net.sasconsul.flags.domain.Country}.
 */
@RestController
@RequestMapping("/api")
@Transactional
